...
Once the `conda-forge` channel has been enabled, `youtube-search-python` can be installed with:

```
conda install youtube-search-python
```

It is possible to list all of the versions of `youtube-search-python` available on your platform with:
